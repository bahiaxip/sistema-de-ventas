...
{    
    ...
    {        
        ...
        //remplazamos caracter "," por el caracter "."" por si se ha escrito con coma el precio del producto.
        $producto->price=str_replace(",", ".", $producto->price);        
    ...
    public function update(ProductoUpdateRequest $request, Producto $producto)
    {
        ...
        $producto->price=str_replace(",",".",$request->price);
